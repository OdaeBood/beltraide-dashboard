  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      <Card className="col-span-12 md:col-span-6">
        <CardHeader><CardTitle>Co-ops by Sector</CardTitle></CardHeader>
      ...
      <Card className="col-span-12 md:col-span-6">
        <CardHeader><CardTitle>Value Chain Mix</CardTitle></CardHeader>
        <CardContent className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={byValueChain} dataKey="count" nameKey="name" outerRadius={88}>
                {byValueChain.map((_, i) => <Cell key={i} />)}
              </Pie>
              <Legend />
              <Tooltip />
            </PieChart>
      ...
      <Card className="col-span-12">
        <CardHeader><CardTitle>Total Capacity by District</CardTitle></CardHeader>
        <CardContent className="h-64">
          <ResponsiveContainer width="100%" height="100%">
